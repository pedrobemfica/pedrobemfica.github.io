...
export class Products {
    constructor() {
        ...
        this.comboProducts = [
            ...
            {productId: 6, name: 'Pacote bioimpedância Vitória', price: 650, image: './assets/services/bioimpedancia.jpeg', location: 'Vitória',
            description: '10 exames de bioimpedância. 35% de desconto. Local: Vitória/ES', 
            credits: [{serviceId: 7, quantity: 10}]},

            {productId: 7, name: 'Pacote bioimpedância Belo Horizonte', price: 650, image: './assets/services/bioimpedancia.jpeg', location: 'Belo Horizonte',
